 ...
 * Modified by: David Klanac
 * Date Modified: Mon Apr 19 16:01 -0500
 * Modification: Added an optional event.target attribute that is passed only within the CMS internally.
 * In your format, you must pass [system-view:internal]target: true,[/system-view:internal].  This flag will ensure that
 * your hyperlinks for the event.url attribute redirects to the parent frame.
	...
	for (i=0; i<segCnt; i++) {
		...
		html +=
			"<div class='" + className + event.className.join(' ') + "' style='position:absolute;z-index:8;left:"+left+"px'>" +
				"<a" + (event.target ? " target='_parent'" : '') + (event.url ? " href='" + htmlEscape(event.url) + "'" : '') + ">" +
