...
<!--
	...
	Or create your own:
		Example:
			<xsl:with-param name="mask" select="'mmmm d, h TT'" />
		Gives:
			December 3, 4 PM
...
--><xsl:stylesheet exclude-result-prefixes="hh" version="1.0" xmlns:hh="http://www.hannonhill.com/XSL/Functions" xmlns:xalan="http://xml.apache.org/xalan" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xalan:component functions="dateFormat" prefix="hh">
